...
@interface DropDown : UIView <UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource>
- (nonnull instancetype)initWithFramea:(CGRect)framea SetArray:(NSMutableArray * __nonnull)SetArray OBJC_DESIGNATED_INITIALIZER;
